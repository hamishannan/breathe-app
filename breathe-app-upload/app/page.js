      ...
      <div style={{
        ...
        <style>{`
          @media (min-width: 768px) {
            ...
            .technique-card .card-arrow {
              display: none !important;
            }
            .technique-card .phase-tags {
        ...
        `}</style>
        <div style={{ maxWidth: '600px', margin: '0 auto' }} className="technique-grid">
          <div style={{ textAlign: 'center', marginBottom: '32px', gridColumn: '1 / -1' }}>
            ...
            {Object.entries(breathingTechniques).map(([key, tech]) => (
              ...
              >
                ...
                <div className="card-content" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div className="phase-tags" style={{
                    display: 'flex',
                    gap: '6px',
                    flexWrap: 'wrap'
                  }}>
